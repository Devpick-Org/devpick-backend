...
.requestMatchers("/dev/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/trends/ecosystem").permitAll()
                        .requestMatchers(HttpMethod.GET, "/trends/ecosystem/bootcamp-thumbnail").permitAll()
                        .requestMatchers(HttpMethod.GET, "/v1/trends/ecosystem/bootcamp-thumbnail").permitAll()
